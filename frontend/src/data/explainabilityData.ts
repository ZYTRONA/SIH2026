...
export const CORE_REASONING_POINTS: ReasoningPoint[] = [
  {
    ...
    detail:
      'Avoids heavy Princess Astrid compression pack (78% multi-year pack), reducing structural hull stress by 42% compared to the direct route.',
  ...
  },
  {
    ...
    summary: 'Maintains 22+ NM buffer from tracked tabular clusters.',
    detail:
      'Trajectory avoids projected drift vector of giant tabular iceberg A-76A and Amery Ice Shelf bergy bit swarms, dropping collision risk from 7.4% to 1.6%.',
    metric: '22 NM CPA (P_coll 1.6%)',
    iconName: 'Mountain',
  ...
  },
  {
    ...
    summary: 'Favorable track angle relative to 24-knot SSE katabatic gale.',
    detail:
  ...
  },
  {
    ...
    summary: 'Consumes 152.6 m³ total heavy fuel oil.',
    detail:
      'Only 9.8 m³ above the hydrodynamically assisted route, while avoiding the massive 30+ tons fuel penalty of continuous icebreaker ramming.',
    metric: '152.6 m³ total burn',
    iconName: 'Fuel',
  ...
  },
  {
    ...
    summary: 'Total transit duration of 94 hours 12 minutes.',
    detail:
      'Arrives at Bharati Station within 8 hours of the high-risk direct cut, keeping scientific expedition logistics on schedule.',
    metric: '94h 12m (+8.0h vs Fastest)',
    iconName: 'Clock',
...
// SHAP Feature Contributions for the ML Risk Model (40% Iceberg, 30% Sea Ice, 20% Wind, 10% Current)
export const SHAP_FEATURE_CONTRIBUTIONS: ShapFeatureContribution[] = [
  {
    feature: 'Iceberg Proximity',
    category: 'Safety',
    shapValue: 0.40,
    importancePct: 40,
    rawFeatureValue: '22 NM CPA (A-76A avoided)',
    impactDescription: 'Generous safety corridor avoids active tabular drift cones and calving fields',
    color: '#38BDF8', // Sky Blue
  },
  {
    feature: 'Sea Ice Concentration',
    category: 'Environmental',
    shapValue: 0.30,
    importancePct: 30,
    rawFeatureValue: '48% SIC (First-year leads)',
    impactDescription: 'Lower concentration significantly decreases structural hull risk',
    color: '#06B6D4', // Cyan
  },
  {
    feature: 'Wind Velocity (Katabatic)',
    category: 'Environmental',
    shapValue: 0.20,
    importancePct: 20,
  ...
  {
    feature: 'Ocean Current Vector',
    category: 'Environmental',
    shapValue: 0.10,
    importancePct: 10,
    rawFeatureValue: '+1.8 kts boundary assist',
    impactDescription: 'Antarctic Coastal Current streamline provides positive kinetic push',
    color: '#6366F1', // Indigo
  },
];
...
export const FASTEST_ROUTE_REJECTION = {
  ...
  comparison: {
    travelTime: { balanced: '94h 12m', fastest: '86h 12m', delta: '-8h 00m' },
    riskScore: { balanced: '22 / 100 (LOW)', fastest: '41 / 100 (MODERATE)', delta: '+19 pts Risk' },
    seaIceConcentration: { balanced: '48% max', fastest: '78% heavy pack', delta: '+30% Heavy Ice' },
    icebergCPA: { balanced: '22.0 NM clearance', fastest: '4.8 NM proximity', delta: 'Hazard Incursion' },
    icebreakerRequired: { balanced: 'Autonomous (No escort)', fastest: 'Mandatory Escort Advised', delta: 'High Dependency' },
  },
  verdict:
    'Trading an 8-hour transit buffer for a 46% reduction in structural and iceberg collision risk represents the soundest navigational decision for NCPOR SA Agulhas II expeditions.',
};
