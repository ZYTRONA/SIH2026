    ...
    <div className="bg-white border border-slate-200/90 shadow-xs rounded-xl p-5 space-y-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <span className="text-[10px] font-mono text-slate-500">
              Phase: <strong className="text-sky-700">{phaseName}</strong>
            </span>
          </div>
        </div>

        {/* Simulation Time Readout */}
        <div className="flex items-center gap-1.5 text-xs font-mono text-slate-700 bg-slate-50 px-3 py-1.5 rounded-lg border border-slate-200">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 font-mono">
        ...
        <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200/90 space-y-1">
          <div className="flex items-center justify-between text-slate-500 text-xs">
            ...
            <span className="text-[10px] text-sky-700 font-semibold">Pack Area</span>
          </div>
          <span className="text-xl font-bold font-sans text-slate-900 block">
        ...
        <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200/90 space-y-1">
          ...
          <span className="text-xl font-bold font-sans text-amber-800 block">
        ...
        <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200/90 space-y-1">
          ...
          <span className="text-xl font-bold font-sans text-orange-800 block">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 text-xs font-mono pt-1">
        ...
        <div className="p-2.5 rounded-lg bg-slate-50 border border-slate-200">
          ...
          <span className="text-sky-700 font-bold">{environment.airTempC}°C</span>
        </div>
      ...
      {/* Narrative Footer */}
      <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 text-xs font-mono text-slate-700 leading-relaxed flex items-start justify-between gap-3">
        <p className="flex-1">
          <strong className="text-slate-900 font-bold">Tactical Log: </strong>
          {narrative}
        </p>
        ...
        {onRecalculateRouteClick && (
          <button
            ...
            className="flex-shrink-0 px-3 py-1.5 rounded-lg bg-sky-50 hover:bg-sky-100 text-sky-700 border border-sky-200 text-xs font-mono font-bold transition-all shadow-xs"
          >
            Trigger Scenario
          </button>
        )}
