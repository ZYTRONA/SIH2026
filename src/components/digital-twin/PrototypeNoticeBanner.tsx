...
export const PrototypeNoticeBanner: React.FC = () => {
  return (
    <div className="bg-amber-50/80 border border-amber-200 shadow-xs rounded-xl p-4 space-y-2">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-amber-200/70 pb-2">
        <div className="flex items-center gap-2">
          ...
          <span className="px-2.5 py-1 rounded-md text-xs font-mono font-bold bg-amber-100 text-amber-900 border border-amber-300 tracking-wider shadow-xs">
            SIMULATION / DECISION-SUPPORT PROTOTYPE
          </span>
          <span className="text-[11px] font-mono text-amber-800 hidden sm:inline">
            Deterministic Kinematic & Cryospheric Testbed
          </span>
        </div>

        <div className="flex items-center gap-2 text-[11px] font-mono text-amber-800">
      ...
      <div className="flex items-start gap-2.5 text-xs text-amber-950 font-sans leading-relaxed">
        ...
        <p className="text-[11px]">
          <strong className="text-amber-900 font-mono font-semibold">Prototype Notice: </strong>
